...
namespace InventorySystem1._0
{
    public partial class frmcustomers : Form
    {
        ...
        private void btn_New_Click_1(object sender, EventArgs e)
        {
            ...
            config.Load_DTG("Select ID as 'ID' ,FIRSTNAME as 'Firstname',LASTNAME as 'Lastname',ADDRESS as 'Address',MOBILE as 'Mobile' From tblperson", dtg_listcustomer);
        ...
        private void btn_saveuser_Click(object sender, EventArgs e)
        {
            ...
            if (txt_firstname.Text == "" || txt_lastname.Text == "" || txt_address.Text == "" || txt_mobile.Text == "")
            {
                MessageBox.Show("Field must be filled up", "Invalid", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
            }
            else
            {
                sql = "insert into tblperson (FIRSTNAME, LASTNAME, ADDRESS, MOBILE) "

                     + "values('" + txt_firstname.Text
                                                              + "','" + txt_lastname.Text
                                                              + "','" + txt_address.Text
                                                              + "','" + txt_mobile.Text
                                                              + "')";
        ...
        {
            {
                lbl_id1.Text = dtg_listcustomer.CurrentRow.Cells[0].Value.ToString();
